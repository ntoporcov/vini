...
struct ManageServicesView: View {
            ...
            ScrollView {
                LazyVStack(alignment: .leading, spacing: 0) {
                    ...
                    if !store.unlistedServices.isEmpty {
                        SectionHeader(title: "Not in Mbappe's known list")
    ...
    private func rowDivider(after service: MbappeService, in list: [MbappeService]) -> some View {
        Group {
    ...
    private var emptyState: some View {
        VStack(spacing: 8) {
            ...
            Text("Nothing hidden or unlisted")
                .font(.subheadline)
                .foregroundStyle(.secondary)
            Text("Services you hide, and tools not in Mbappe's known list, show up here.")
                .font(.caption)
