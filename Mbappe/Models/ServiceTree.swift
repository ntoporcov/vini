...
enum ServiceTree {
    ...
    static func build(groups: [ServiceGroup], services: [MbappeService]) -> [ServiceTreeNode] {
        ...
        // Top-level groups, sorted by name.
    ...
    private static func node(
        ...
        servicesByID: [String: MbappeService],
        visited: Set<UUID>
    ) -> ServiceTreeNode {
    ...
    private static func serviceNode(_ service: MbappeService) -> ServiceTreeNode {
        ServiceTreeNode(
            id: service.id,
